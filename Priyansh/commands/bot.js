...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "😁") || (event.body.toLowerCase() == "😁😁") || (event.body.toLowerCase() == "😁😁😁") || (event.body.toLowerCase() == "😁😁😁😁")) {
     return api.sendMessage( "𝐊𝐚𝐛𝐡𝐢 𝐓𝐨 𝐁𝐫𝐮𝐬𝐡 𝐊𝐚𝐫 𝐋𝐢𝐲𝐚 𝐊𝐚𝐫𝐨 𝐓𝐮𝐦𝐡𝐚𝐫𝐞 𝐃𝐚𝐧𝐭𝐨 𝐌𝐞 𝐊𝐢𝐝𝐚 𝐅𝐚𝐬𝐚 𝐇𝐮𝐚 𝐃𝐢𝐤𝐡 𝐑𝐚𝐡𝐚 𝐁𝐚𝐢 😝😝",threadID);

       
   };

   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "Owner")) {
     return api.sendMessage("💝🥀𝐎𝐖𝐍𝐄𝐑:- ☞ 𒁍 ⟬ 𓆩𝐑𝐚𝐣 ‣⃟ ⃝𑁍𓆪᭄ 達 ⟭ ꪹ 爾 ᯽⸺›⁐‡𖣴‣ ⸨⸙⸩☜ 💫\n🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 Raj\n😳𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝🤓:- ☞ https://www.facebook.com/profile.php?id=100085303477541&mibextid=ZbWKwL", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon ha")) {
     return api.sendMessage("He is Raj. He Gives his name Raj everywhare", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "bot chumma de") || (event.body.toLowerCase() == "bot kiss me")) {
  ...
  if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "😒😒")) {
     return api.sendMessage("️️𝐓𝐢𝐫𝐜𝐡𝐢 𝐧𝐚𝐳𝐚𝐫𝐢𝐲𝐚 𝐦𝐨𝐫𝐢 𝐡𝐚𝐚𝐲𝐞 𝐡𝐚𝐚𝐲𝐞 𝐡𝐚𝐚𝐲𝐞 𝐀𝐩𝐧𝐚 𝐟𝐚𝐜𝐞 𝐬𝐢𝐝𝐡𝐚 𝐤𝐚𝐫 𝐥𝐨 𝐧𝐚𝐡𝐢 𝐭𝐨 𝐚𝐢𝐬𝐞 𝐡𝐢 𝐡𝐨 𝐣𝐚𝐢𝐲𝐞𝐠𝐚 𝐭𝐢𝐫𝐜𝐡𝐚 𝐏𝐡𝐢𝐫 𝐬𝐚𝐛𝐡𝐢 𝐭𝐮𝐦𝐡𝐞 𝐭𝐢𝐫𝐜𝐡𝐢 𝐦𝐮𝐡𝐢 𝐡𝐢 𝐤𝐚𝐡𝐞𝐧𝐠𝐞", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "") || (event.body.toLowerCase() == "is 😈")) {
     return api.sendMessage("𝐀𝐫𝐞 𝐘𝐚𝐚𝐫 𝐘𝐞𝐡 𝐒𝐚𝐛 𝐌𝐭 𝐁𝐡𝐞𝐣𝐚 𝐊𝐚𝐫 𝐌𝐞𝐫𝐚 𝐒𝐚𝐫 𝐃𝐚𝐫𝐝 𝐇𝐨𝐭𝐚 𝐇𝐚𝐢 🤕🤕", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "lob you") || (event.body.toLowerCase() == "i lob you")) {
   ...
   if ((event.body.toLowerCase() == "&fuck") || (event.body.toLowerCase() == "&Fuck")) {
     return api.sendMessage("🏔️🏝️Raj Ƞɛ ꌗƥɛçɪɑɭɭɣ Ƭuɱ 🌊🪺Jɑɪʂɛ Ƭɧɑɽƙɪɣɵ Ƙɛ Ɬɪɣɛ•• 🏞️🌬️Ɣɑɧ çɵɱɱɑƞɗ Ɦɑʈɑ Ɗɪɣɑ Ɦɑɪ↗↘ Sɵɽɽɣ Ɠɣuʂ••😹🫶", threadID);
   };
