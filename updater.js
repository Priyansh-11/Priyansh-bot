...
(async () => {
  const { data: versions } = await axios.get('https://raw.githubusercontent.com/priyanshu192/check2/main/versions.json');
  ...
  for (const filePath in files) {
    ...
    let getFile;
    try {
      const response = await axios.get(`https://github.com/priyanshu192/check2/raw/main/${filePath}`, {
  ...
  const { data: packageHTML } = await axios.get("https://github.com/priyanshu192/check2/blob/main/package.json");
